...
import {closeModalRegister,register, closeModal} from '../redux/actions'
            ...
            <div style={styles.contUtama}>
                ...
                <div style={styles.contRight}>
                    <div style={styles.contForm}>
                        ...
                        <p style={styles.goToRegis} >Already Have an Account?  </p>
                        <p style={styles.goToRegis} as={Link} to="/login">Go to Login </p>
                    </div>
                </div>
                <Modal show={this.props.errorRegister}>
                    <Modal.Header>
                        <Modal.Title>Error</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>{this.props.msgErrRegis}</Modal.Body>
                    <Modal.Footer>
                ...
                <Modal show={this.props.registerModal}>
                    <Modal.Header>
                        <Modal.Title>Information</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>{this.props.msgSuccessReg}</Modal.Body>
                    <Modal.Footer>
                        <Button variant="primary" onClick={this.props.closeModalRegister}>
                            OK
                        </Button>
                    </Modal.Footer>
                </Modal>
...
const mapStateToProps = (state) => {
    return {
        msgSuccessReg : state.userReducer.msgSuccessReg,
        registerModal : state.userReducer.registerModal,
        errorRegister : state.userReducer.errorRegister,
        msgErrRegis : state.userReducer.msgErrRegis
    }
}

// export default connect(mapStateToProps, { register,closeModalRegister })(RegisPage)
export default connect(mapStateToProps,{register,closeModalRegister, closeModal}) (RegisPage)